...
<body>
    ...
    <div class="cookie">
        <div class="contenidor">
            <div class="subcontenidor">
                <div class="cookies">
                    <p>Esta web utiliza cookies para asegurar que tenga la mejor experiencia en nuestra web
    ...
    <article class="promocional">
        <div class="video">
                   <iframe class="videoyoutube"width="560" height="315" src="https://www.youtube.com/embed/4WSUTZVN1to" frameborder="0" allowfullscreen></iframe>
        </div>
